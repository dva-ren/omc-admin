import type { I, R } from '@omc-space/api-client/shared/api-client.f6e4339e'

async function jsonDataAttachResponse(response: Response) {
 ...
 * @returns
 */
function parseOptions(options: Partial<R>): RequestInit {
...
export const fetchAdaptor: I<typeof fetch>
